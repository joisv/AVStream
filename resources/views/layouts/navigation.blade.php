<nav x-cloak class="ease-in duration-100 absolute sm:relative">
    <div class="p-4 lg:w-[20%] md:w-[27%] z-50 fixed ease-in duration-200" x-data="{
        ...
        <div class="bg-rose-500 space-y-2 min-h-[95vh] p-3 relative shadow-2xl overflow-y-auto">
            ...
            <div>
                <button
                    ...
                    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" class="ease-in duration-200"
                        :class="open ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path
                ...
                <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div x-cloak class="w-[90%] bg-rose-400 space-y-2 p-3 shadow-2xl">
            ...
            <div>
                <button
                    ...
                    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" class="ease-in duration-200"
                        :class="openSub ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path
            ...
            <div>
                <button
                    ...
                    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" class="ease-in duration-200"
                        :class="openStream ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path
