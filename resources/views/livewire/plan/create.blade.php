            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div>
                        ...
                        <select id="countries"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700" wire:model.defer="billing_cycle">
