<div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg space-y-4">
    ...
    <h1 class="font-semibold text-yellow-600 text-base rounded-sm p-2 bg-rose-300 bg-opacity-75mt-2 ">Alert⚠ : <span
            class="text-gray-800 font-medium">To allow maintenance mode to be bypassed using a secret token, you may use
            the secret option to specify a maintenance mode bypass token: <span
                class="text-black underline">https://example.com/your-secret-maintenance-code</span></span></h1>
</div>
