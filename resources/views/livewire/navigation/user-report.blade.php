<div wire:init="getReportCount" class="relative flex space-x-2 items-center w-full">
    ...
    @if ($reportCount > 0)
        <div
            class="w-5 h-5 text-sm bg-rose-500 absolute rounded-full text-center font-medium text-white -top-4 right-0">
            {{ $reportCount }}</div>
    @endif
</div>
