<div class="min-h-screen text-white mb-[25vh]">
    <div class="mt-20">
                ...
                <x-dropdown-navigation align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div class="hover:text-rose-400 ease-in duration-150 txt-base sm:text-lg">Sort by:
        ...
        @endif
        <div class="sm:mx-14 mx-2 space-y-10">
