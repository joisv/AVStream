...
<div class="min-h-screen text-white md:mb-[20vh] mb-[7vh] p-2 lg:p-0">
    <div class="mt-20">
        ...
        @endif
        <div class="mb-[25vh] sm:mx-14 mx-2 space-y-10">
            <div class="grid sm:grid-cols-3 lg:grid-cols-4 grid-cols-2 text-gray-400 gap-2">
                @empty(!$posts)
                            ...
                            <a href="{{ route('watch', ['c' => $post->code]) }}">
                                <div
                                    ...
                                    <img data-src="{{ asset('storage/' . $post->poster_path) }}" alt="" srcset=""
                                        class="w-full h-full object-cover object-center lazy" loading="lazy">
                                    @if ($post->isVip)
                                        <div
                    ...
                    @endforelse
                @endempty
                <div class="lg:col-span-4 sm:col-span-3 col-span-2 min-h-[50vh] flex justify-center items-center w-full" wire:loading.flex>
                    <x-icons.loading-circle />
                </div>
            </div>
            <div class="w-full">
                {{ $posts->onEachSide(5)->links('components.paginations') }}
            </div>
        </div>
    </div>
</div>
