<div class="min-h-screen md:mb-[20vh] mb-[7vh] p-2 lg:p-0">
    <section class="w-full h-44 p-3 flex justify-center items-end">
        <header class="lg:w-[40%] w-[80%] text-center">
            ...
            <x-inputs.text wire:model.debounce.500ms="search" placeholder="Search genres name..." />
        </header>
    </section>
                    ...
                    <div class="text-white flex justify-center" wire:loading.remove>
                        <div class="text-center">
                            <a href="{{ route('genre.show', $genre->slug) }}">
                                <h1 class="w-40 mt-4 text-amber-300 opacity-75 font-semibold text-xl">{{ $genre->name }}</h1>
                                <div class="text-gray-400 font-semibold text-lg">
                                    <h3>{{ $genre->posts->count() }} videos</h3>
                                </div>
                            </a>
                        </div>
